...
\pdfinfo{
/Title (Segmenting Multivariate Time Series with Inertial Hidden Markov Models)
...
\begin{abstract}
    Faced with the problem of segmenting a multivariate time series in an
    unsupervised manner, we derive and test two methods of regularizing hidden
    ...
    The regularized methods developed here are able to perfectly segment the
    human activity data in roughly half of the real-data test cases, with
    accuracy of 94\% and low variation of information. In contrast to the
    ...
    (EM) algorithms to be used for learning. Lastly, we make progress towards
